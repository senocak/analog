...
description: "Java logging best practices with SLF4J, structured logging (JSON), and MDC for request tracing. Includes AI-friendly log formats for Codex debugging. Use when user asks about logging, debugging application flow, or analyzing logs."
---
...
- AI/Codex needs to analyze application behavior
